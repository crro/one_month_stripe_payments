...
# The %{} feature lets you put things in multiline form
#The sku is good to find the product later by the identifier.
# growth_hacking = Product.create(title: "Growth Hacking",
#   subtitle: "Crash Course", author: "Mattan Griffel", length: "30 minutes", price: "4.99",
#   sku: "GROHACK1", details: "You'll get one video", author_image_name: 'teacher-image.jpg',
#   download_url: "https://s3.amazonaws.com/one-month-stripe-payments-david/David+Correa+Orozco+Resume.pdf",
...
#   <p>Follow me on Twitter <a href="https://twitter.com/mattangriffel" target="_blank">@mattangriffel</a></p>})
  ...
  growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly",
    subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months", price: "4.99",
    sku: "GROHACK2", details: "We'll charge you monthly for unlimited access to our mentoring team", author_image_name: 'teacher-image.jpg',
    download_url: "https://s3.amazonaws.com/one-month-stripe-payments-david/David+Correa+Orozco+Resume.pdf",
    description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
  ...
  copywriting_monthly = Product.create(title: "Copywriting monthly",
    subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months", price: "4.99",
    sku: "COPYWRITE2", details: "We'll charge you monthly for unlimited access to our mentoring team", author_image_name: 'teacher-image.jpg',
    download_url: "https://s3.amazonaws.com/one-month-stripe-payments-david/David+Correa+Orozco+Resume.pdf",
    description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
  ...
  analytics_monthly = Product.create(title: "Analytics Monthly",
    subtitle: "Ongoing Course", author: "Mattan Griffel", length: "6 months", price: "4.99",
    sku: "ANALYTICS2", details: "We'll charge you monthly for unlimited access to our mentoring team", author_image_name: 'teacher-image.jpg',
    download_url: "https://s3.amazonaws.com/one-month-stripe-payments-david/David+Correa+Orozco+Resume.pdf",
    description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
